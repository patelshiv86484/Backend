...
export {app}  //export this everywhere not to do re-declaration as const app=express()  in other fiels as all will create their own context and middleware's like app.use(json()) is not applied in all.